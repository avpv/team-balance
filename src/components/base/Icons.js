...
<path d="M665.139,231.908l11.219-11.219-9.239-9.24-7.974,8.195s-5.307-3.658-8.277-1.348A39.55,39.55,0,0,1,646.879,221a2.512,2.512,0,0,0-.991,3.2h0a2.52,2.52,0,0,0,3.463,1.19l5.219-2.734" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"/>
        ...
        // Compare - two arrows pointing in opposite directions
        compare: `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="${strokeWidth}" stroke-linecap="round" stroke-linejoin="round" class="${className}"><path d="M4 8h12"></path><path d="M12 4l4 4-4 4"></path><path d="M20 16H8"></path><path d="M12 12l-4 4 4 4"></path></svg>`
    };
