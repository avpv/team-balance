...
export default {
    ...
    settings: {
        ...
        modals: {
            ...
            removePlayer: {
                confirmMessage: '¿Eliminar a {{name}}?'
            }
        }
    },
    ...
    compare: {
        ...
        confidence: {
            ...
            low: 'Incierto',
            'very-low': 'Nuevo',
            tooltip: 'Desviación del rating: {{rd}} — más bajo significa rating más confiable'
        },

        // Transitivity violations
        violations: {
            title: '{{count}} contradicciones detectadas',
            andMore: '...y {{count}} más',
            hint: 'Estas comparaciones circulares reducen la precisión del rating. Considere volver a comparar estos jugadores.',
            confirmRecord: 'Esto creará una contradicción:\n{{cycle}}\n\n¿Registrar de todos modos?'
        },
    ...
    teams: {
        ...
        results: {
            ...
            variantSelectorLabel: 'Variantes de generación de equipos',
            variantNumber: 'Opción {{number}}',
            variantLabel: 'Opción {{number}} — {{balance}} diferencia ELO'
        },
