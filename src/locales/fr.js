...
export default {
    ...
    compare: {
        ...
        confidence: {
            ...
            low: 'Incertain',
            'very-low': 'Nouveau',
            tooltip: 'Déviation du classement: {{rd}} — plus bas signifie un classement plus fiable'
        },
    ...
    teams: {
        ...
        results: {
            ...
            variantSelectorLabel: 'Variantes de génération d\'équipes',
            variantNumber: 'Option {{number}}',
            variantLabel: 'Option {{number}} — {{balance}} différence ELO'
        },
