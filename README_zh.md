...
[![Demo](https://img.shields.io/badge/demo-live-brightgreen?style=flat-square)](https://avpv.github.io/team-balance/?lang=zh)
...
TeamBalance 使用与专业棋手和精英体育联盟相同的评分系统。现在人人可用。

不再争论。不再浪费时间。只有数学上平衡的队伍。
...
[ELO 评分](docs/elo.md)。衡量技能的黄金标准。
[团队优化器](docs/optimizer.md)。优化队伍的最聪明方式。
